    ...
    return (
        <>
            <Form onChange={setValue}>
                ...
                <Step index={1} question='Felhasználás célja'
                      options={['munkábajárás', 'rövid túrázás (10-50 km)', 'hosszabb túrázás (50 km felett)', 'Vegyes használat']}/>
                <Step index={2} question='Felhasználás helyszíne'
                      options={['sík terep', 'dombosabb vidék', 'hegyi bringázás, downhill', 'Vegyes']}/>
            ...
            {show && solutions.map((solution, i) => <Result key={i}>{solution[value[i]]}</Result>)}
        </>
    )
};
